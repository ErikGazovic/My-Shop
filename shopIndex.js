...
async function createTables(params) {
    ...
    await pool.query("CREATE TABLE IF NOT EXISTS cart ( cart_id SERIAL PRIMARY KEY, product_id INT REFERENCES products(id), user_id INT REFERENCES users(user_id), size VARCHAR(2) )");
