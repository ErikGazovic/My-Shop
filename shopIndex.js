...
async function createTables(params) {
    await pool.query("CREATE TABLE IF NOT EXISTS products ( id SERIAL PRIMARY KEY, image VARCHAR(100), product_name VARCHAR(50), target_group VARCHAR(10), category VARCHAR(20), product_type VARCHAR(20), brand_logo VARCHAR(100), brand_name VARCHAR(50), price DOUBLE, color VARCHAR(15) )");
